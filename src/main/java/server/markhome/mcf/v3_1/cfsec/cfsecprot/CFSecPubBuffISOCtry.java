// Description: Java 17 implJustPubementation of a ISOCtry buffer
...
public class CFSecPubBuffISOCtry
	implements ICFSecPubISOCtry, Comparable<Object>, Serializable
{
	...
	public int getClassCode() {
		return( ICFSecPubISOCtry.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFSecPubISOCtryHPKey ) {
			ICFSecPubISOCtryHPKey rhs = (ICFSecPubISOCtryHPKey)obj;
			if( getRequiredISOCtryId() != rhs.getRequiredISOCtryId() ) {
				return( false );
			}
			return( true );
	...
	public String getXmlAttrFragment() {
		String ret = pkey.getXmlAttrFragment()
			+ " RequiredRevision=\"" + Integer.toString( getRequiredRevision() ) + "\"" + "\"" + Short.toString( getRequiredISOCtryId() ) + "\"" + "\"" + StringEscapeUtils.escapeXml11( getRequiredISOCode() ) + "\"" + "\"" + StringEscapeUtils.escapeXml11( getRequiredName() ) + "\"";
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFSecPubBuffISOCtry" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

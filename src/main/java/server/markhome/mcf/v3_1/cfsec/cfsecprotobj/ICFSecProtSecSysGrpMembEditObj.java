// Description: Java 25 Protected Instance Edit Object interface for CFSec SecSysGrpMemb.
...
public interface ICFSecProtSecSysGrpMembEditObj
	extends ICFSecProtSecSysGrpMembObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecProtSecSysGrpMembObj.
	 */
	ICFSecProtSecSysGrpMembObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecProtSecSysGrpMembObj.
	 */
	ICFSecProtSecSysGrpMembObj getOrigAsSecSysGrpMemb();
	 ...
	 */
	ICFSecProtSecSysGrpMembObj create();

	/*
	 *	Update the instance.
	 */
	ICFSecProtSecSysGrpMembEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFSecProtSecSysGrpMembEditObj deleteInstance();
	...
	/**
	 *	Get the ICFSecProtSecSysGrpObj instance referenced by the Group key.
	 *

// Description: Java 25 protected interface for a ISOTZone by OffsetIdx index key object
...
/**
 *	ICFSecProtISOTZoneByOffsetIdxKeys has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */

// Description: Java 25 Protected Instance Edit Object interface for CFSec SecClusRole.
...
public interface ICFSecProtSecClusRoleEditObj
	extends ICFSecProtSecClusRoleObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecProtSecClusRoleObj.
	 */
	ICFSecProtSecClusRoleObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecProtSecClusRoleObj.
	 */
	ICFSecProtSecClusRoleObj getOrigAsSecClusRole();
	 ...
	 */
	ICFSecProtSecClusRoleObj create();

	/*
	 *	Update the instance.
	 */
	ICFSecProtSecClusRoleEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFSecProtSecClusRoleEditObj deleteInstance();

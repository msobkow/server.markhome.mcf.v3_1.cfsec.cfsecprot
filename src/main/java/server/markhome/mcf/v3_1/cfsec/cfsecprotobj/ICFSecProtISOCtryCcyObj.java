// Description: Java 25 Object interface for CFSecProt ISOCtryCcy.
...
public interface ICFSecProtISOCtryCcyObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFSecProtISOCtryCcy.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFSecProtISOCtryCcyObj instance which should be subsequently referenced.
	 */
	ICFSecProtISOCtryCcyObj realise();
	 ...
	 *
	 *	@return	ICFSecProtISOCtryCcyObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtISOCtryCcyObj read();
	 ...
	 *	@return	ICFSecProtISOCtryCcyObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtISOCtryCcyObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this ISOCtryCcy instance.
	 *
	 *	@return	The newly locked ICFSecProtISOCtryCcyEditObj edition of this instance.
	 */
	ICFSecProtISOCtryCcyEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecProtISOCtryCcyEditObj edition of this instance.
	 */
	ICFSecProtISOCtryCcyEditObj getEdit();

	/**
	 *	Get the current edition of this ISOCtryCcy instance as a ICFSecProtISOCtryCcyEditObj.
	 *
	 *	@return	The ICFSecProtISOCtryCcyEditObj edition of this instance.
	 */
	ICFSecProtISOCtryCcyEditObj getEditAsISOCtryCcy();

	/**
	 *	Get the ICFSecProtISOCtryCcyTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecProtISOCtryCcyTableObj table cache which manages this instance.
	 */
	ICFSecProtISOCtryCcyTableObj getISOCtryCcyTable();
	...
	/**
	 *	Get the ICFSecProtISOCtryCcy instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecProtISOCtryCcy instance which currently backs this object.
	 */
	ICFSecProtISOCtryCcy getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecProtISOCtryCcy value );
	 ...
	 *	@return	ICFSecProtISOCtryCcy instance which currently backs this object.
	 */
	ICFSecProtISOCtryCcy getISOCtryCcyRec();

	/**
	 *	Get the primary key of this instance.
	 *
	 *	@return	ICFSecProtISOCtryCcyPKey primary key for this instance.
	 */
	ICFSecProtISOCtryCcyPKey getPKey();
	 ...
	 *	This method should only be invoked by implementation internals.
	 *
	 *	@param ICFSecProtISOCtryCcyPKey primary key value for this instance.
	 */
	void setPKey( ICFSecProtISOCtryCcyPKey value );

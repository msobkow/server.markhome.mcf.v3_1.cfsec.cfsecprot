...
// Description: Java Protected Factory interface for ISOCtry.
...
public interface ICFSecProtISOCtryFactory
{
	...
	/**
	 *	Allocate a protected primary history key for ISOCtry instances.
	 *
	 ...
	 *	@return	The new instance.
	 */
	public ICFSecProtISOCtry newRec();
	 ...
	 *	@return	The new instance.
	 */
	public ICFSecProtISOCtryH newHRec();

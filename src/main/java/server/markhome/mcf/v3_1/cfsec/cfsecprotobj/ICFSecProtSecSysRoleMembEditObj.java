// Description: Java 25 Protected Instance Edit Object interface for CFSec SecSysRoleMemb.
...
public interface ICFSecProtSecSysRoleMembEditObj
	extends ICFSecProtSecSysRoleMembObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecProtSecSysRoleMembObj.
	 */
	ICFSecProtSecSysRoleMembObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecProtSecSysRoleMembObj.
	 */
	ICFSecProtSecSysRoleMembObj getOrigAsSecSysRoleMemb();
	 ...
	 */
	ICFSecProtSecSysRoleMembObj create();

	/*
	 *	Update the instance.
	 */
	ICFSecProtSecSysRoleMembEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFSecProtSecSysRoleMembEditObj deleteInstance();

// Description: Java 25 protected interface for a SecSysGrpInc history primary key object
...
/**
 *	ICFSecProtSecSysGrpIncHPKey Protected History Primary Key interface for SecSysGrpInc has CodeVis Protected, meaning that any only user interfaces and application code specific to the defining schema can access it.
 *		requiredSecSysGrpId	Required object attribute SecSysGrpId.
 *		requiredInclName	Required object attribute InclName. */
public interface ICFSecProtSecSysGrpIncHPKey
{

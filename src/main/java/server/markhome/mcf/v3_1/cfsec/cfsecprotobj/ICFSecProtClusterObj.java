// Description: Java 25 Object interface for CFSecProt Cluster.
...
public interface ICFSecProtClusterObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFSecProtCluster.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFSecProtClusterObj instance which should be subsequently referenced.
	 */
	ICFSecProtClusterObj realise();
	 ...
	 *
	 *	@return	ICFSecProtClusterObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtClusterObj read();
	 ...
	 *	@return	ICFSecProtClusterObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtClusterObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this Cluster instance.
	 *
	 *	@return	The newly locked ICFSecProtClusterEditObj edition of this instance.
	 */
	ICFSecProtClusterEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecProtClusterEditObj edition of this instance.
	 */
	ICFSecProtClusterEditObj getEdit();

	/**
	 *	Get the current edition of this Cluster instance as a ICFSecProtClusterEditObj.
	 *
	 *	@return	The ICFSecProtClusterEditObj edition of this instance.
	 */
	ICFSecProtClusterEditObj getEditAsCluster();

	/**
	 *	Get the ICFSecProtClusterTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecProtClusterTableObj table cache which manages this instance.
	 */
	ICFSecProtClusterTableObj getClusterTable();
	...
	/**
	 *	Get the ICFSecProtCluster instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecProtCluster instance which currently backs this object.
	 */
	ICFSecProtCluster getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecProtCluster value );
	 ...
	 *	@return	ICFSecProtCluster instance which currently backs this object.
	 */
	ICFSecProtCluster getClusterRec();

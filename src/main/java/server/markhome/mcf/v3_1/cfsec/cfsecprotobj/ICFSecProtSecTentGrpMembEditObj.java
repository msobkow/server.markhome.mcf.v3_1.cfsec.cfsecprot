// Description: Java 25 Protected Instance Edit Object interface for CFSec SecTentGrpMemb.
...
public interface ICFSecProtSecTentGrpMembEditObj
	extends ICFSecProtSecTentGrpMembObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecProtSecTentGrpMembObj.
	 */
	ICFSecProtSecTentGrpMembObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecProtSecTentGrpMembObj.
	 */
	ICFSecProtSecTentGrpMembObj getOrigAsSecTentGrpMemb();
	 ...
	 */
	ICFSecProtSecTentGrpMembObj create();

	/*
	 *	Update the instance.
	 */
	ICFSecProtSecTentGrpMembEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFSecProtSecTentGrpMembEditObj deleteInstance();
	...
	/**
	 *	Get the ICFSecProtSecTentGrpObj instance referenced by the Group key.
	 *

// Description: Java 25 Object interface for CFSecProt SecTentRole.
	...
	extends ICFLibAnyObj
{
	 ...
	 *
	 *	@return	CFSecProtSecTentRoleObj instance which should be subsequently referenced.
	 */
	ICFSecProtSecTentRoleObj realise();
	 ...
	 *
	 *	@return	ICFSecProtSecTentRoleObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtSecTentRoleObj read();
	 ...
	 *	@return	ICFSecProtSecTentRoleObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtSecTentRoleObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this SecTentRole instance.
	 *
	 *	@return	The newly locked ICFSecProtSecTentRoleEditObj edition of this instance.
	 */
	ICFSecProtSecTentRoleEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecProtSecTentRoleEditObj edition of this instance.
	 */
	ICFSecProtSecTentRoleEditObj getEdit();

	/**
	 *	Get the current edition of this SecTentRole instance as a ICFSecProtSecTentRoleEditObj.
	 *
	 *	@return	The ICFSecProtSecTentRoleEditObj edition of this instance.
	 */
	ICFSecProtSecTentRoleEditObj getEditAsSecTentRole();

	/**
	 *	Get the ICFSecProtSecTentRoleTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecProtSecTentRoleTableObj table cache which manages this instance.
	 */
	ICFSecProtSecTentRoleTableObj getSecTentRoleTable();
	...
	/**
	 *	Get the ICFSecProtSecTentRole instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecProtSecTentRole instance which currently backs this object.
	 */
	ICFSecProtSecTentRole getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecProtSecTentRole value );
	 ...
	 *	@return	ICFSecProtSecTentRole instance which currently backs this object.
	 */
	ICFSecProtSecTentRole getSecTentRoleRec();

// Description: Java 25 implementation of a SecClusGrpMemb protected primary key buffer object
...
/*
 *	CFSecProtSecClusGrpMembPKey protected Primary Key for SecClusGrpMemb buffers
 *		requiredSecClusGrpId	Required object attribute SecClusGrpId.
 *		requiredLoginId	Required object attribute LoginId.
 */
public class CFSecProtSecClusGrpMembPKey
	implements ICFSecProtSecClusGrpMembPKey, Comparable<Object>, Serializable
{
	...
	public String getXmlAttrFragment() {
		String ret = ""  + "\"" + getRequiredSecClusGrpId().toString() + "\"" + "\"" + StringEscapeUtils.escapeXml11( getRequiredLoginId() ) + "\"";
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFSecProtSecClusGrpMembPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

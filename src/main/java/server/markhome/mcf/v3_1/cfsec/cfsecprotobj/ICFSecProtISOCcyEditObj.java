// Description: Java 25 Protected Instance Edit Object interface for CFSec ISOCcy.
...
public interface ICFSecProtISOCcyEditObj
	extends ICFSecProtISOCcyObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecProtISOCcyObj.
	 */
	ICFSecProtISOCcyObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecProtISOCcyObj.
	 */
	ICFSecProtISOCcyObj getOrigAsISOCcy();
	 ...
	 */
	ICFSecProtISOCcyObj create();

	/*
	 *	Update the instance.
	 */
	ICFSecProtISOCcyEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFSecProtISOCcyEditObj deleteInstance();
	...
	/**
	 *	Get a list ICFSecProtISOCtryCcyObj instances referenced by the Ctry key.
	 *

// Description: Java 25 protected interface for a SecTentGrpMemb history primary key object
...
/**
 *	ICFSecProtSecTentGrpMembHPKey Protected History Primary Key interface for SecTentGrpMemb has CodeVis Protected, meaning that any only user interfaces and application code specific to the defining schema can access it.
 *		requiredSecTentGrpId	Required object attribute SecTentGrpId.
 *		requiredLoginId	Required object attribute LoginId. */
public interface ICFSecProtSecTentGrpMembHPKey
{

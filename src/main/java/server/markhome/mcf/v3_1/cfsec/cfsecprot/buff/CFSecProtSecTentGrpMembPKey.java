// Description: Java 25 implementation of a SecTentGrpMemb protected primary key buffer object
...
/*
 *	CFSecProtSecTentGrpMembPKey protected Primary Key for SecTentGrpMemb buffers
 *		requiredSecTentGrpId	Required object attribute SecTentGrpId.
 *		requiredLoginId	Required object attribute LoginId.
 */
public class CFSecProtSecTentGrpMembPKey
	implements ICFSecProtSecTentGrpMembPKey, Comparable<Object>, Serializable
{
	protected $implIJavaAtomType first implIJavaAtomType each implCommaIJavaAtomType empty empty )$ requiredSecTentGrpId;
	protected $implIJavaAtomType first implIJavaAtomType each implCommaIJavaAtomType empty empty )$ requiredLoginId;

	public CFSecProtSecTentGrpMembPKey() {
	...
	public String getXmlAttrFragment() {
		String ret = ""  + "\"" + getRequiredSecTentGrpId().toString() + "\"" + "\"" + StringEscapeUtils.escapeXml11( getRequiredLoginId() ) + "\"";
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFSecProtSecTentGrpMembPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

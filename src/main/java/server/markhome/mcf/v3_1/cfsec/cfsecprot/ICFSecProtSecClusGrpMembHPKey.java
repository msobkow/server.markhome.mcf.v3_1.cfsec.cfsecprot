// Description: Java 25 protected interface for a SecClusGrpMemb history primary key object
...
/**
 *	ICFSecProtSecClusGrpMembHPKey Protected History Primary Key interface for SecClusGrpMemb has CodeVis Protected, meaning that any only user interfaces and application code specific to the defining schema can access it.
 *		requiredSecClusGrpId	Required object attribute SecClusGrpId.
 *		requiredLoginId	Required object attribute LoginId. */
public interface ICFSecProtSecClusGrpMembHPKey
{

// Description: Java 25 Protected Instance Edit Object interface for CFSec SecSysRoleEnables.
...
public interface ICFSecProtSecSysRoleEnablesEditObj
	extends ICFSecProtSecSysRoleEnablesObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecProtSecSysRoleEnablesObj.
	 */
	ICFSecProtSecSysRoleEnablesObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecProtSecSysRoleEnablesObj.
	 */
	ICFSecProtSecSysRoleEnablesObj getOrigAsSecSysRoleEnables();
	 ...
	 */
	ICFSecProtSecSysRoleEnablesObj create();

	/*
	 *	Update the instance.
	 */
	ICFSecProtSecSysRoleEnablesEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFSecProtSecSysRoleEnablesEditObj deleteInstance();
	...
	/**
	 *	Get the ICFSecProtSecSysRoleObj instance referenced by the SysRole key.
	 *

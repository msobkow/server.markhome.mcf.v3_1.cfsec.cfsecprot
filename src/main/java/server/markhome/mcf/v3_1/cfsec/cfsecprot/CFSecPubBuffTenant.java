// Description: Java 17 implJustPubementation of a Tenant buffer
	...
	implements ICFSecPubTenant, Comparable<Object>, Serializable
{
	...
	public int getClassCode() {
		return( ICFSecPubTenant.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFSecPubTenantHPKey ) {
			ICFSecPubTenantHPKey rhs = (ICFSecPubTenantHPKey)obj;
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void setTenant( ICFSecPubTenant src ) {
		...
		setJustPubRequiredTenantName(src.getRequiredTenantName());
	}
	...
	public String toString() {
		String ret = "<CFSecPubBuffTenant" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

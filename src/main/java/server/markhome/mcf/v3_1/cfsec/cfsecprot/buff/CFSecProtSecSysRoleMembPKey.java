// Description: Java 25 implementation of a SecSysRoleMemb protected primary key buffer object
...
/*
 *	CFSecProtSecSysRoleMembPKey protected Primary Key for SecSysRoleMemb buffers
 *		requiredSecSysRoleId	Required object attribute SecSysRoleId.
 *		requiredLoginId	Required object attribute LoginId.
 */
public class CFSecProtSecSysRoleMembPKey
	implements ICFSecProtSecSysRoleMembPKey, Comparable<Object>, Serializable
{
	protected $implIJavaAtomType first implIJavaAtomType each implCommaIJavaAtomType empty empty )$ requiredSecSysRoleId;
	protected $implIJavaAtomType first implIJavaAtomType each implCommaIJavaAtomType empty empty )$ requiredLoginId;

	public CFSecProtSecSysRoleMembPKey() {
	...
	public String getXmlAttrFragment() {
		String ret = ""  + "\"" + getRequiredSecSysRoleId().toString() + "\"" + "\"" + StringEscapeUtils.escapeXml11( getRequiredLoginId() ) + "\"";
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFSecProtSecSysRoleMembPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

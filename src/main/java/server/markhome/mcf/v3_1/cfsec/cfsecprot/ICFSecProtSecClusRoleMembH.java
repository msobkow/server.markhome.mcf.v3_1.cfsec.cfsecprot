// Description: Java 25 protected interface for a SecClusRoleMemb history object
...
/**
 *	ICFSecProtSecClusRoleMembH provides access to protected history records matching the CFSecProtSecClusRoleMemb object change history.
 */
public interface ICFSecProtSecClusRoleMembH
{
	...
	public ICFSecProtSecClusRoleMembHPKey getProtPKey();
	public void setProtPKey( ICFSecProtSecClusRoleMembHPKey pkey );

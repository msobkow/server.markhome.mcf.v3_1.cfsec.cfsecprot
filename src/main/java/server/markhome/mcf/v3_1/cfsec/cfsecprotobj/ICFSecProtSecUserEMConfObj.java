// Description: Java 25 Object interface for CFSecProt SecUserEMConf.
...
public interface ICFSecProtSecUserEMConfObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFSecProtSecUserEMConf.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFSecProtSecUserEMConfObj instance which should be subsequently referenced.
	 */
	ICFSecProtSecUserEMConfObj realise();
	 ...
	 *
	 *	@return	ICFSecProtSecUserEMConfObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtSecUserEMConfObj read();
	 ...
	 *	@return	ICFSecProtSecUserEMConfObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtSecUserEMConfObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this SecUserEMConf instance.
	 *
	 *	@return	The newly locked ICFSecProtSecUserEMConfEditObj edition of this instance.
	 */
	ICFSecProtSecUserEMConfEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecProtSecUserEMConfEditObj edition of this instance.
	 */
	ICFSecProtSecUserEMConfEditObj getEdit();

	/**
	 *	Get the current edition of this SecUserEMConf instance as a ICFSecProtSecUserEMConfEditObj.
	 *
	 *	@return	The ICFSecProtSecUserEMConfEditObj edition of this instance.
	 */
	ICFSecProtSecUserEMConfEditObj getEditAsSecUserEMConf();

	/**
	 *	Get the ICFSecProtSecUserEMConfTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecProtSecUserEMConfTableObj table cache which manages this instance.
	 */
	ICFSecProtSecUserEMConfTableObj getSecUserEMConfTable();
	...
	/**
	 *	Get the ICFSecProtSecUserEMConf instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecProtSecUserEMConf instance which currently backs this object.
	 */
	ICFSecProtSecUserEMConf getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecProtSecUserEMConf value );
	 ...
	 *	@return	ICFSecProtSecUserEMConf instance which currently backs this object.
	 */
	ICFSecProtSecUserEMConf getSecUserEMConfRec();

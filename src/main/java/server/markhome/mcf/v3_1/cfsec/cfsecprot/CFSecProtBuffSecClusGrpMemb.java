// Description: Java 17 implJustProtementation of a SecClusGrpMemb buffer
	...
	implements ICFSecProtSecClusGrpMemb, Comparable<Object>, Serializable
{
	...
	public ICFSecProtSecClusGrp getRequiredContainerGroup(ICFLibKeyHash256 argSecClusGrpId) {
		...
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getRequiredContainerGroup", 0, "ICFSecProtSchema.getBackingCFSec().getTableSecClusGrp()");
		}
	...
	public String getXmlAttrFragment() {
		String ret = pkey.getXmlAttrFragment()
			+ " RequiredRevision=\"" + Integer.toString( getRequiredRevision() ) + "\"" + "\"" + getRequiredSecClusGrpId().toString() + "\"" + "\"" + StringEscapeUtils.escapeXml11( getRequiredLoginId() ) + "\"";
		return( ret );
	}

// Description: Java 25 Object interface for CFSecProt SecClusGrp.
...
public interface ICFSecProtSecClusGrpObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFSecProtSecClusGrp.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFSecProtSecClusGrpObj instance which should be subsequently referenced.
	 */
	ICFSecProtSecClusGrpObj realise();
	 ...
	 *
	 *	@return	ICFSecProtSecClusGrpObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtSecClusGrpObj read();
	 ...
	 *	@return	ICFSecProtSecClusGrpObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtSecClusGrpObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this SecClusGrp instance.
	 *
	 *	@return	The newly locked ICFSecProtSecClusGrpEditObj edition of this instance.
	 */
	ICFSecProtSecClusGrpEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecProtSecClusGrpEditObj edition of this instance.
	 */
	ICFSecProtSecClusGrpEditObj getEdit();

	/**
	 *	Get the current edition of this SecClusGrp instance as a ICFSecProtSecClusGrpEditObj.
	 *
	 *	@return	The ICFSecProtSecClusGrpEditObj edition of this instance.
	 */
	ICFSecProtSecClusGrpEditObj getEditAsSecClusGrp();

	/**
	 *	Get the ICFSecProtSecClusGrpTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecProtSecClusGrpTableObj table cache which manages this instance.
	 */
	ICFSecProtSecClusGrpTableObj getSecClusGrpTable();
	...
	/**
	 *	Get the ICFSecProtSecClusGrp instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecProtSecClusGrp instance which currently backs this object.
	 */
	ICFSecProtSecClusGrp getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecProtSecClusGrp value );
	 ...
	 *	@return	ICFSecProtSecClusGrp instance which currently backs this object.
	 */
	ICFSecProtSecClusGrp getSecClusGrpRec();

// Description: Java 25 Protected Instance Edit Object interface for CFSec SecTentRoleMemb.
...
public interface ICFSecProtSecTentRoleMembEditObj
	extends ICFSecProtSecTentRoleMembObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecProtSecTentRoleMembObj.
	 */
	ICFSecProtSecTentRoleMembObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecProtSecTentRoleMembObj.
	 */
	ICFSecProtSecTentRoleMembObj getOrigAsSecTentRoleMemb();
	 ...
	 */
	ICFSecProtSecTentRoleMembObj create();

	/*
	 *	Update the instance.
	 */
	ICFSecProtSecTentRoleMembEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFSecProtSecTentRoleMembEditObj deleteInstance();
	...
	/**
	 *	Get the ICFSecProtSecTentRoleObj instance referenced by the Role key.
	 *

// Description: Java 25 Object interface for CFSecProt SecSession.
	...
	extends ICFLibAnyObj
{
	 ...
	 *
	 *	@return	CFSecProtSecSessionObj instance which should be subsequently referenced.
	 */
	ICFSecProtSecSessionObj realise();
	 ...
	 *
	 *	@return	ICFSecProtSecSessionObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtSecSessionObj read();
	 ...
	 *	@return	ICFSecProtSecSessionObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtSecSessionObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this SecSession instance.
	 *
	 *	@return	The newly locked ICFSecProtSecSessionEditObj edition of this instance.
	 */
	ICFSecProtSecSessionEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecProtSecSessionEditObj edition of this instance.
	 */
	ICFSecProtSecSessionEditObj getEdit();

	/**
	 *	Get the current edition of this SecSession instance as a ICFSecProtSecSessionEditObj.
	 *
	 *	@return	The ICFSecProtSecSessionEditObj edition of this instance.
	 */
	ICFSecProtSecSessionEditObj getEditAsSecSession();

	/**
	 *	Get the ICFSecProtSecSessionTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecProtSecSessionTableObj table cache which manages this instance.
	 */
	ICFSecProtSecSessionTableObj getSecSessionTable();
	...
	/**
	 *	Get the ICFSecProtSecSession instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecProtSecSession instance which currently backs this object.
	 */
	ICFSecProtSecSession getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecProtSecSession value );
	 ...
	 *	@return	ICFSecProtSecSession instance which currently backs this object.
	 */
	ICFSecProtSecSession getSecSessionRec();

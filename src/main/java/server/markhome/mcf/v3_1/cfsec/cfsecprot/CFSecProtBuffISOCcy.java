// Description: Java 17 implJustProtementation of a ISOCcy buffer
	...
	implements ICFSecProtISOCcy, Comparable<Object>, Serializable
{
	...
	@Override
	public List<ICFSecProtISOCtryCcy> getOptionalChildrenCtry(short argISOCcyId) {
		...
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "getOptionalChildrenCtry", 0, "ICFSecProtSchema.getBackingCFSec().getTableISOCtryCcy()");
		}
	...
	public String toString() {
		String ret = "<CFSecProtBuffISOCcy" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

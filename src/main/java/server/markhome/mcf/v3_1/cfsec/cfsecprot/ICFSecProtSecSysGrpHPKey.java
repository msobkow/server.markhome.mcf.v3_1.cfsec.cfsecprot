// Description: Java 25 protected interface for a SecSysGrp history primary key object
...
/**
 *	ICFSecProtSecSysGrpHPKey Protected History Primary Key interface for SecSysGrp has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredSecSysGrpId	Required object attribute SecSysGrpId. */
public interface ICFSecProtSecSysGrpHPKey
{

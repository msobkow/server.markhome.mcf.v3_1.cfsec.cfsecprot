// Description: Java 25 Object interface for CFSecProt SecSysRole.
...
public interface ICFSecProtSecSysRoleObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFSecProtSecSysRole.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFSecProtSecSysRoleObj instance which should be subsequently referenced.
	 */
	ICFSecProtSecSysRoleObj realise();
	 ...
	 *
	 *	@return	ICFSecProtSecSysRoleObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtSecSysRoleObj read();
	 ...
	 *	@return	ICFSecProtSecSysRoleObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtSecSysRoleObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this SecSysRole instance.
	 *
	 *	@return	The newly locked ICFSecProtSecSysRoleEditObj edition of this instance.
	 */
	ICFSecProtSecSysRoleEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecProtSecSysRoleEditObj edition of this instance.
	 */
	ICFSecProtSecSysRoleEditObj getEdit();

	/**
	 *	Get the current edition of this SecSysRole instance as a ICFSecProtSecSysRoleEditObj.
	 *
	 *	@return	The ICFSecProtSecSysRoleEditObj edition of this instance.
	 */
	ICFSecProtSecSysRoleEditObj getEditAsSecSysRole();

	/**
	 *	Get the ICFSecProtSecSysRoleTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecProtSecSysRoleTableObj table cache which manages this instance.
	 */
	ICFSecProtSecSysRoleTableObj getSecSysRoleTable();
	...
	/**
	 *	Get the ICFSecProtSecSysRole instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecProtSecSysRole instance which currently backs this object.
	 */
	ICFSecProtSecSysRole getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecProtSecSysRole value );
	 ...
	 *	@return	ICFSecProtSecSysRole instance which currently backs this object.
	 */
	ICFSecProtSecSysRole getSecSysRoleRec();

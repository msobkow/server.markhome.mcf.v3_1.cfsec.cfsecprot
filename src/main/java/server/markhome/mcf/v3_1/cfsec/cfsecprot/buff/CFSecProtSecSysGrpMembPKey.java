// Description: Java 25 implementation of a SecSysGrpMemb protected primary key buffer object
...
/*
 *	CFSecProtSecSysGrpMembPKey protected Primary Key for SecSysGrpMemb buffers
...
{
	protected $implIJavaAtomType first implIJavaAtomType each implCommaIJavaAtomType empty empty )$ requiredSecSysGrpId;
	...
	public String getXmlAttrFragment() {
		String ret = ""  + "\"" + getRequiredSecSysGrpId().toString() + "\"" + "\"" + StringEscapeUtils.escapeXml11( getRequiredLoginId() ) + "\"";
		return( ret );
	}

	@Override
	public String toString() {
		String ret = "<CFSecProtSecSysGrpMembPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}

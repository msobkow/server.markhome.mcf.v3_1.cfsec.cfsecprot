// Description: Java 25 Object interface for CFSecProt ISOCtry.
...
public interface ICFSecProtISOCtryObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFSecProtISOCtry.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFSecProtISOCtryObj instance which should be subsequently referenced.
	 */
	ICFSecProtISOCtryObj realise();
	 ...
	 *
	 *	@return	ICFSecProtISOCtryObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtISOCtryObj read();
	 ...
	 *	@return	ICFSecProtISOCtryObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtISOCtryObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this ISOCtry instance.
	 *
	 *	@return	The newly locked ICFSecProtISOCtryEditObj edition of this instance.
	 */
	ICFSecProtISOCtryEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecProtISOCtryEditObj edition of this instance.
	 */
	ICFSecProtISOCtryEditObj getEdit();

	/**
	 *	Get the current edition of this ISOCtry instance as a ICFSecProtISOCtryEditObj.
	 *
	 *	@return	The ICFSecProtISOCtryEditObj edition of this instance.
	 */
	ICFSecProtISOCtryEditObj getEditAsISOCtry();

	/**
	 *	Get the ICFSecProtISOCtryTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecProtISOCtryTableObj table cache which manages this instance.
	 */
	ICFSecProtISOCtryTableObj getISOCtryTable();
	...
	/**
	 *	Get the ICFSecProtISOCtry instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecProtISOCtry instance which currently backs this object.
	 */
	ICFSecProtISOCtry getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecProtISOCtry value );
	 ...
	 *	@return	ICFSecProtISOCtry instance which currently backs this object.
	 */
	ICFSecProtISOCtry getISOCtryRec();

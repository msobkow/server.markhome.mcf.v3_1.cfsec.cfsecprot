// Description: Java 25 protected interface for a TableInfo history object
...
/**
 *	ICFSecProtTableInfoH provides access to protected history records matching the CFSecProtTableInfo object change history.
 */
public interface ICFSecProtTableInfoH
{
	public int getClassCode();

	public ICFSecProtTableInfoHPKey getProtPKey();
	public void setProtPKey( ICFSecProtTableInfoHPKey pkey );

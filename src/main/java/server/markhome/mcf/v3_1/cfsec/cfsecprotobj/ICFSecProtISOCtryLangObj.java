// Description: Java 25 Object interface for CFSecProt ISOCtryLang.
	...
	extends ICFLibAnyObj
{
	 ...
	 *
	 *	@return	CFSecProtISOCtryLangObj instance which should be subsequently referenced.
	 */
	ICFSecProtISOCtryLangObj realise();
	 ...
	 *
	 *	@return	ICFSecProtISOCtryLangObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtISOCtryLangObj read();
	 ...
	 *	@return	ICFSecProtISOCtryLangObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtISOCtryLangObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this ISOCtryLang instance.
	 *
	 *	@return	The newly locked ICFSecProtISOCtryLangEditObj edition of this instance.
	 */
	ICFSecProtISOCtryLangEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecProtISOCtryLangEditObj edition of this instance.
	 */
	ICFSecProtISOCtryLangEditObj getEdit();

	/**
	 *	Get the current edition of this ISOCtryLang instance as a ICFSecProtISOCtryLangEditObj.
	 *
	 *	@return	The ICFSecProtISOCtryLangEditObj edition of this instance.
	 */
	ICFSecProtISOCtryLangEditObj getEditAsISOCtryLang();

	/**
	 *	Get the ICFSecProtISOCtryLangTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecProtISOCtryLangTableObj table cache which manages this instance.
	 */
	ICFSecProtISOCtryLangTableObj getISOCtryLangTable();
	...
	/**
	 *	Get the ICFSecProtISOCtryLang instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecProtISOCtryLang instance which currently backs this object.
	 */
	ICFSecProtISOCtryLang getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecProtISOCtryLang value );
	 ...
	 *	@return	ICFSecProtISOCtryLang instance which currently backs this object.
	 */
	ICFSecProtISOCtryLang getISOCtryLangRec();

	/**
	 *	Get the primary key of this instance.
	 *
	 *	@return	ICFSecProtISOCtryLangPKey primary key for this instance.
	 */
	ICFSecProtISOCtryLangPKey getPKey();
	 ...
	 *	This method should only be invoked by implementation internals.
	 *
	 *	@param ICFSecProtISOCtryLangPKey primary key value for this instance.
	 */
	void setPKey( ICFSecProtISOCtryLangPKey value );

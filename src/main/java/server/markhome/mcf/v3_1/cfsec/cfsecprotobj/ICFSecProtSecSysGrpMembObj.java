// Description: Java 25 Object interface for CFSecProt SecSysGrpMemb.
	...
	extends ICFLibAnyObj
{
	...
	/**
	 *	Realise this instance of a SecSysGrpMemb.
	 *
	 *	@return	CFSecProtSecSysGrpMembObj instance which should be subsequently referenced.
	 */
	ICFSecProtSecSysGrpMembObj realise();
	 ...
	 *
	 *	@return	ICFSecProtSecSysGrpMembObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtSecSysGrpMembObj read();
	 ...
	 *	@return	ICFSecProtSecSysGrpMembObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtSecSysGrpMembObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this SecSysGrpMemb instance.
	 *
	 *	@return	The newly locked ICFSecProtSecSysGrpMembEditObj edition of this instance.
	 */
	ICFSecProtSecSysGrpMembEditObj beginEdit();
	...
	/**
	 *	Get the current edition of this SecSysGrpMemb instance.
	 *
	 *	@return	The ICFSecProtSecSysGrpMembEditObj edition of this instance.
	 */
	ICFSecProtSecSysGrpMembEditObj getEdit();

	/**
	 *	Get the current edition of this SecSysGrpMemb instance as a ICFSecProtSecSysGrpMembEditObj.
	 *
	 *	@return	The ICFSecProtSecSysGrpMembEditObj edition of this instance.
	 */
	ICFSecProtSecSysGrpMembEditObj getEditAsSecSysGrpMemb();

	/**
	 *	Get the ICFSecProtSecSysGrpMembTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecProtSecSysGrpMembTableObj table cache which manages this instance.
	 */
	ICFSecProtSecSysGrpMembTableObj getSecSysGrpMembTable();
	...
	/**
	 *	Get the ICFSecProtSecSysGrpMemb instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecProtSecSysGrpMemb instance which currently backs this object.
	 */
	ICFSecProtSecSysGrpMemb getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecProtSecSysGrpMemb value );
	 ...
	 *	@return	ICFSecProtSecSysGrpMemb instance which currently backs this object.
	 */
	ICFSecProtSecSysGrpMemb getSecSysGrpMembRec();

	/**
	 *	Get the primary key of this instance.
	 *
	 *	@return	ICFSecProtSecSysGrpMembPKey primary key for this instance.
	 */
	ICFSecProtSecSysGrpMembPKey getPKey();
	 ...
	 *	This method should only be invoked by implementation internals.
	 *
	 *	@param ICFSecProtSecSysGrpMembPKey primary key value for this instance.
	 */
	void setPKey( ICFSecProtSecSysGrpMembPKey value );

// Description: Java 25 Protected Instance Edit Object interface for CFSec SecUserPWReset.
...
public interface ICFSecProtSecUserPWResetEditObj
	extends ICFSecProtSecUserPWResetObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecProtSecUserPWResetObj.
	 */
	ICFSecProtSecUserPWResetObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecProtSecUserPWResetObj.
	 */
	ICFSecProtSecUserPWResetObj getOrigAsSecUserPWReset();
	 ...
	 */
	ICFSecProtSecUserPWResetObj create();

	/*
	 *	Update the instance.
	 */
	ICFSecProtSecUserPWResetEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFSecProtSecUserPWResetEditObj deleteInstance();

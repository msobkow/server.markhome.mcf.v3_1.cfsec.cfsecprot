// Description: Java 25 Object interface for CFSecProt Tenant.
...
public interface ICFSecProtTenantObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFSecProtTenant.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFSecProtTenantObj instance which should be subsequently referenced.
	 */
	ICFSecProtTenantObj realise();
	 ...
	 *
	 *	@return	ICFSecProtTenantObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtTenantObj read();
	 ...
	 *	@return	ICFSecProtTenantObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtTenantObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this Tenant instance.
	 *
	 *	@return	The newly locked ICFSecProtTenantEditObj edition of this instance.
	 */
	ICFSecProtTenantEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecProtTenantEditObj edition of this instance.
	 */
	ICFSecProtTenantEditObj getEdit();

	/**
	 *	Get the current edition of this Tenant instance as a ICFSecProtTenantEditObj.
	 *
	 *	@return	The ICFSecProtTenantEditObj edition of this instance.
	 */
	ICFSecProtTenantEditObj getEditAsTenant();

	/**
	 *	Get the ICFSecProtTenantTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecProtTenantTableObj table cache which manages this instance.
	 */
	ICFSecProtTenantTableObj getTenantTable();
	...
	/**
	 *	Get the ICFSecProtTenant instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecProtTenant instance which currently backs this object.
	 */
	ICFSecProtTenant getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecProtTenant value );

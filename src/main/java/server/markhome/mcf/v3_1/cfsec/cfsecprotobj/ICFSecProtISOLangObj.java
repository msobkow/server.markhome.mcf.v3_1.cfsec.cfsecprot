// Description: Java 25 Object interface for CFSecProt ISOLang.
...
public interface ICFSecProtISOLangObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFSecProtISOLang.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFSecProtISOLangObj instance which should be subsequently referenced.
	 */
	ICFSecProtISOLangObj realise();
	 ...
	 *
	 *	@return	ICFSecProtISOLangObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtISOLangObj read();
	 ...
	 *	@return	ICFSecProtISOLangObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtISOLangObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this ISOLang instance.
	 *
	 *	@return	The newly locked ICFSecProtISOLangEditObj edition of this instance.
	 */
	ICFSecProtISOLangEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecProtISOLangEditObj edition of this instance.
	 */
	ICFSecProtISOLangEditObj getEdit();

	/**
	 *	Get the current edition of this ISOLang instance as a ICFSecProtISOLangEditObj.
	 *
	 *	@return	The ICFSecProtISOLangEditObj edition of this instance.
	 */
	ICFSecProtISOLangEditObj getEditAsISOLang();

	/**
	 *	Get the ICFSecProtISOLangTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecProtISOLangTableObj table cache which manages this instance.
	 */
	ICFSecProtISOLangTableObj getISOLangTable();
	...
	/**
	 *	Get the ICFSecProtISOLang instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecProtISOLang instance which currently backs this object.
	 */
	ICFSecProtISOLang getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecProtISOLang value );
	 ...
	 *	@return	ICFSecProtISOLang instance which currently backs this object.
	 */
	ICFSecProtISOLang getISOLangRec();

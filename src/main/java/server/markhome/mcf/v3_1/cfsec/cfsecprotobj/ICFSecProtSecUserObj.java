// Description: Java 25 Object interface for CFSecProt SecUser.
...
{
	/**
	 *	Initially, the class code for an object is ICFSecProtSecUser.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFSecProtSecUserObj instance which should be subsequently referenced.
	 */
	ICFSecProtSecUserObj realise();
	 ...
	 *
	 *	@return	ICFSecProtSecUserObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtSecUserObj read();
	 ...
	 *	@return	ICFSecProtSecUserObj the reference to the cached or read (realised) instance.
	 */
	ICFSecProtSecUserObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this SecUser instance.
	 *
	 *	@return	The newly locked ICFSecProtSecUserEditObj edition of this instance.
	 */
	ICFSecProtSecUserEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecProtSecUserEditObj edition of this instance.
	 */
	ICFSecProtSecUserEditObj getEdit();

	/**
	 *	Get the current edition of this SecUser instance as a ICFSecProtSecUserEditObj.
	 *
	 *	@return	The ICFSecProtSecUserEditObj edition of this instance.
	 */
	ICFSecProtSecUserEditObj getEditAsSecUser();

	/**
	 *	Get the ICFSecProtSecUserTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecProtSecUserTableObj table cache which manages this instance.
	 */
	ICFSecProtSecUserTableObj getSecUserTable();
	...
	/**
	 *	Get the ICFSecProtSecUser instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecProtSecUser instance which currently backs this object.
	 */
	ICFSecProtSecUser getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecProtSecUser value );
	 ...
	 *	@return	ICFSecProtSecUser instance which currently backs this object.
	 */
	ICFSecProtSecUser getSecUserRec();
	...
	/**
	 *	Get the array of optional ICFSecProtSecSysGrpMembObj array of instances referenced by the SysSecGrpMemb key.
	 *
	 *	@return	The optional ICFSecProtSecSysGrpMembObj[] array of instances referenced by the SysSecGrpMemb key.
	 */
	 ...
	 *	@return	The optional ICFSecProtSecSysGrpMembObj[] array of instances referenced by the SysSecGrpMemb key.
	 */
	List<ICFSecProtSecSysGrpMembObj> getOptionalChildrenSysSecGrpMemb( boolean forceRead );

	/**
	 *	Get the array of optional ICFSecProtSecClusGrpMembObj array of instances referenced by the ClusSecGrpMemb key.
	 *
	 *	@return	The optional ICFSecProtSecClusGrpMembObj[] array of instances referenced by the ClusSecGrpMemb key.
	 */
	 ...
	 *	@return	The optional ICFSecProtSecClusGrpMembObj[] array of instances referenced by the ClusSecGrpMemb key.
	 */
	List<ICFSecProtSecClusGrpMembObj> getOptionalChildrenClusSecGrpMemb( boolean forceRead );

	/**
	 *	Get the array of optional ICFSecProtSecTentGrpMembObj array of instances referenced by the TentSecGrpMemb key.
	 *
	 *	@return	The optional ICFSecProtSecTentGrpMembObj[] array of instances referenced by the TentSecGrpMemb key.
	 */
	 ...
	 *	@return	The optional ICFSecProtSecTentGrpMembObj[] array of instances referenced by the TentSecGrpMemb key.
	 */
	List<ICFSecProtSecTentGrpMembObj> getOptionalChildrenTentSecGrpMemb( boolean forceRead );

// Description: Java 17 implJustProtementation of a ISOCtry buffer
	...
	implements ICFSecProtISOCtry, Comparable<Object>, Serializable
{
	...
	@Override
	public List<ICFSecProtISOCtryCcy> getOptionalComponentsCcy(short argISOCtryId) {
	...
	@Override
	public List<ICFSecProtISOCtryLang> getOptionalComponentsLang(short argISOCtryId) {
		ICFSecProtSchema targetBackingCFSec = ICFSecProtSchema.getBackingCFSec();
		if (targetBackingCFSec == null) {

// Description: Java 25 protected interface for a ISOCtryLang history primary key object
...
/**
 *	ICFSecProtISOCtryLangHPKey Protected History Primary Key interface for ISOCtryLang has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredISOCtryId	Required object attribute ISOCtryId.
 *		requiredISOLangId	Required object attribute ISOLangId. */
public interface ICFSecProtISOCtryLangHPKey
{

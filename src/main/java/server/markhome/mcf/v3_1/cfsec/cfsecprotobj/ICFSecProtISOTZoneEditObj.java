// Description: Java 25 Protected Instance Edit Object interface for CFSec ISOTZone.
...
public interface ICFSecProtISOTZoneEditObj
	extends ICFSecProtISOTZoneObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecProtISOTZoneObj.
	 */
	ICFSecProtISOTZoneObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecProtISOTZoneObj.
	 */
	ICFSecProtISOTZoneObj getOrigAsISOTZone();
	 ...
	 */
	ICFSecProtISOTZoneObj create();

	/*
	 *	Update the instance.
	 */
	ICFSecProtISOTZoneEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFSecProtISOTZoneEditObj deleteInstance();

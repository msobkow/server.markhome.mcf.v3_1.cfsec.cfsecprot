// Description: Java 25 protected interface for a SecTentRole history primary key object
...
/**
 *	ICFSecProtSecTentRoleHPKey Protected History Primary Key interface for SecTentRole has CodeVis Protected, meaning that any only user interfaces and application code specific to the defining schema can access it.
 *		requiredSecTentRoleId	Required object attribute SecTentRoleId. */
public interface ICFSecProtSecTentRoleHPKey
{
